...
namespace Script
{
    ...
    public class CompareExcel
    {
        public CompareExcel()
        {
            ...
            var listTables = ExcelByBase.Data.ImportToListTable(dir1).ToDictionary(p => p.TableName);
            var listTables2 = ExcelByBase.Data.ImportToListTable(dir2).ToDictionary(p => p.TableName);
